...
export declare const GuidoModuleFactoryFn: GuidoModuleFactory;
export declare const GuidoModuleFactoryWasm: Uint8Array;
/**
 * Instantiate `GuidoModule` using bundled binaries. Module constructor and files can be overriden.
 */
export declare const instantiateGuidoModule: (GuidoModuleFactoryIn?: GuidoModuleFactory, wasmBinaryIn?: Uint8Array) => Promise<GuidoModule>;
/**
